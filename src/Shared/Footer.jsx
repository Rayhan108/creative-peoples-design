...
import {FaLinkedinIn, FaTencentWeibo, FaTwitter } from 'react-icons/fa';
const Footer = () => {
    return (
        ...
        <div className=''>
            <div className=' text-[#B4B4B4]   w-9/12 mx-auto'>
                ...
                <hr style={{color:"F7F7F7"}} className="mt-5 w-[1120px] h-5"></hr>
{/*  */}
            </div>
            ...
            <div className=' pb-12 '>
                <div className=' text-white  w-9/12 mx-auto  bg-[#7A7A7A]'>
                    <div className=' p-4 flex justify-between bg-[#262424]'>
